<template>
  <div class="h-full">
    <div
      class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 col-start-1 col-span-3 lg:col-span-1 lg:col-start-2"
    >
      <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <img
          class="mx-auto h-24 w-auto"
          src="http://fchhis.migfus.net/images/logo.png"
          alt="Your Company"
        />
        <h2
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          >
            ...
            <div>
              ...
              <div class="mt-1">
                <Field
                  v-model="$pass.params.confirmPassword"
            ...
            <div>
              <AppButton
                v-if="$pass.config.approved"
                :loading="$pass.config.loading"
                block
                color="success"
              >
...
const schema = Yup.object({
  newPassword: Yup.string()
    ...
    .min(8, 'Minimum of 8 characters for better security.'),
