                ...
                <div class="relative flex h-16 justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            >
                                Calendar
                            <div class="relative inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-black bg-gradient-to-r from-primary-500 to-secondary-200 rounded-full -top-2 right-1">{{ $event.countEvent }}</div>
                            </RouterLink>
                            ...
                            <Popover class="block xl:hidden relative border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 mt-5" v-slot="{ open }">
                                ...
                                >
                                    ...
                                    <div class="absolute hidden md:inline-flex lg:hidden items-center justify-center w-6 h-6 text-xs font-bold text-black bg-gradient-to-r from-primary-500 to-amber-200 rounded-full -top-2 -right-3">{{  $event.countEvent }}</div>
                                </PopoverButton>
                                        ...
                                        <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                            <div class="relative grid bg-white gap-4 p-4">
                                                ...
                                                <RouterLink :to="{name: 'calendar'}" class="lg:hidden -m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                                    ...
                                                    <div class="relative inline-flex items-center justify-center w-7 h-6 text-xs font-bold text-black bg-gradient-to-r from-primary-500 to-amber-200 rounded-full -top-2 right-1">{{ $event.countEvent }}</div>
                                                </RouterLink>
